...
public class RootActivity extends AppCompatActivity {
    ...
    class SAXHandler extends DefaultHandler{
        ...
        // Tag 안의 내용을 저장할 임시 변수
        String content = null;

        // Tag가 열렸는지 확인하기 위한 변수
        boolean initem = false;

        // Tag가 열릴 때 호출되는 Method
        @Override
        public void startElement(String uri, String localName, String qName, Attributes attrs){
            // item Tag가 시작되면 2개의 Tag를 저장할 객체를 생성
    ...
    class Hani{
        ...
        // 객체를 문자열로 표현하는 Method
        // 출력하는 곳에 객체 이름을 설정하면 이 Method의 호출 결과를 출력 합니다.
        @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = new ArrayList<>();
        adapter = new ArrayAdapter<>(RootActivity.this, android.R.layout.simple_list_item_1, list);
